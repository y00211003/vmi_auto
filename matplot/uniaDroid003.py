...
inFile = open('/home/y00211003/10001001002.txt', 'r')
...
bar_width = 0.35
opacity = 0.4
rects1 = plt.bar(index, Y, bar_width, alpha=opacity, align='center', color='b', label='user_10001001003')
plt.xlabel('VMI_version')  
plt.ylabel('uniaLoginTime_second')  
plt.title('UniaBootTimeHistory')  
...
plt.show() 
plt.savefig('/home/y00211003/uniaLoginTime003.png')
